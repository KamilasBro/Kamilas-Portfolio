...
export default function Projects() {
    ...
    function searchProjects(){
        ...
        switch(currentFilter){
            ...
            case "all":
                return(
                    datajs().map(e=>{
                        if(currentSearch===""){//the searching bar is empty
                            return(
            ...
            default:
                return(
                    datajs().map(e=>{
                        if(currentSearch===""){//same as before
    ...
    return (
        <section className="projects" ref={ref} >{/*the intersector thing i mentioned*/}
            <h1 className="section-title" 
            style={inView===true?{animation:"titleAnim 1s"}:{}}
            >Projects</h1>
            <div className="projects-list" style={inView===true?{animation:"projectsAnim1 2s"}:{}}>{/*the intersector thing i mentioned*/}
