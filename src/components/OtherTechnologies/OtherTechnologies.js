  ...
  return (
    <section className="other-technologies" ref={ref}>
      ...
      <ul className="other-technologies-list">
        <li style={inView === true ? { animation: "otherTechAnim1 1.1s" } : {}}>
          <div className="bullet" />
          Git
        </li>
        <li style={inView === true ? { animation: "otherTechAnim1 1.2s" } : {}}>
          <div className="bullet" />
          Figma
        </li>
        <li style={inView === true ? { animation: "otherTechAnim1 1.3s" } : {}}>
          <div className="bullet" />
          Wordpress
        </li>
      </ul>
